...
import {
  lumiSessionInstructionCapability,
  parseSessionInstructionProfile,
  parseTurnContext,
  prependUntrustedTurnContext,
  sessionInstructionText,
  type LumiSessionInstructionProfile
} from '../lumi/session-instructions.js'
...
export class PiAcpAgent implements ACPAgent {
  ...
  private findStoredSession(sessionId: string): StoredSession | null {
  ...
  private async restoreSession(
    ...
    opts?: {
      ...
      instructionProfile?: LumiSessionInstructionProfile | null
    }
    ...
    if (existing && !profileChanged) {
      ;(this.sessions as any).closeAllExcept?.(sessionId)
      return existing
    }
