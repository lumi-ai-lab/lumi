...
func newWeChatChatRuntime(cfg *config.Config, cronService *lumicron.Service) *wechatChatRuntime {
...
func (r *wechatChatRuntime) ensureInitialized(agentID string, sink wechat.ChatEventSink) error {
	r.mu.Lock()
...
func (r *wechatChatRuntime) ensureAgentSession(input wechat.ChatRunInput, sink wechat.ChatEventSink) (string, bool, error) {
	r.mu.Lock()
...
func (r *wechatChatRuntime) executeCronCommands(input wechat.ChatRunInput, streamItems *[]streamItem, currentText *string) error {
