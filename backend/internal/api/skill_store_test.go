...
func TestSkillStoreCRUD(t *testing.T) {
	...
	body, _ := json.Marshal(map[string]any{
		...
		"apps":   map[string]bool{"claude": true, "codex": false, "qwen": false},
	})
	rec = httptest.NewRecorder()
	...
	patch, _ := json.Marshal(map[string]any{
		"apps": map[string]bool{"claude": true, "codex": true, "qwen": true},
	})
	rec = httptest.NewRecorder()
	...
	if !patched.Skill.Apps.Codex || !patched.Skill.Apps.Qwen {
