...
func writeRequesterSandboxPolicy(t *testing.T, path string) {
	t.Helper()
	const raw = `{"version":1,"botId":"bot-123","users":[{"userId":"u1","displayName":"U1","enabled":true,"capabilities":["qdm.cmr.query"],"scope":{"manageAreaIds":["CN18"],"dcManageAreaIds":["CN18"],"categoryLevel1Ids":["12"]}}]}`
